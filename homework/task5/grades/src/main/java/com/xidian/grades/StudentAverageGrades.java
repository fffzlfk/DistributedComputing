...
public class StudentAverageGrades {
    static class MyMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        protected void map(Object key, Text value, Mapper<Object, Text, Text, IntWritable>.Context context)
            ...
            if (strs[3].equals("必修")) {
                context.write(new Text(strs[1]), new IntWritable(Integer.valueOf(strs[4])));
            }
        }
    }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        if (otherArgs.length < 2) {
            System.err.println("Usage StudentAverageGrades <in> [<in>...] <out>");
            System.exit(-1);
        }

        Job job = Job.getInstance(conf, "student-average-grades");
